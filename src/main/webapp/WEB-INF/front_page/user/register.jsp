				...
				<div id="step1" class="step hide">
						...
						<div class="frm_control_group">
							...
							<div class="frm_controls">
								...
								<p class="frm_tips">用于密码找回，一个邮箱只能在本网站使用一次，激活邮箱才能够登录网站</p>
							</div>
						</div>
						<div class="frm_control_group">
							<label class="frm_label">用户名</label>
							<div class="frm_controls">
								<input type="text" name="" class="frm_input passwd"/>
								<p class="frm_tips">必须唯一</p>
							</div>
						</div>
						<div class="frm_control_group">
					...
					<!--<form action="" method="post" id="step3_frm">-->
						...
						<div class="frm_control_group">
							...
							<div class="frm_controls">
								...
								<input type="radio" name="sex" class="frm_input sex"/>男&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="sex" class="frm_input sex"/>女
								<p class="frm_tips"></p>
							</div>
						</div>
					<!--	<div class="frm_control_group">
